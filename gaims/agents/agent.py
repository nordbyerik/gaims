...
class Agent():
    ...
    def observe_communication(self, context: Dict[str, Any]) -> None:
        formatted_context = self.prompt_config.format_observe_communication_context(context)
    ...
    def communicate(self, context: Dict[str, Any]) -> Message:
        formatted_context = self.prompt_config.format_communicate_context(context)
    ...
    def act(self, context: Dict[str, Any]) -> Action:
        formatted_context = self.prompt_config.format_action_context(context)
